...
"Follow-Up Time: <input type=\"text\" name=\"input_9\" /> <br/>"
"<input type=\"submit\" />"
"</form></body></html>";
...
static int begin_request_handler(struct mg_connection* conn)
{
    ...
    char post_data[1024], cdiIp[sizeof(post_data)], deviceIp[sizeof(post_data)], devicePort[sizeof(post_data)], removeZeroFirstSet[sizeof(post_data)],
